      ...
      <header className="h-20 flex items-center justify-between px-6 lg:px-10 bg-white dark:bg-[#1a1a2e] border-b border-gray-200 dark:border-gray-800 shrink-0 z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 h-10 w-64 hover:border-gray-300 dark:hover:border-gray-600 transition-colors focus-within:ring-2 focus-within:ring-primary/50 focus-within:border-primary">
            ...
            <input 
                className="bg-transparent border-none focus:ring-0 text-sm w-full text-black dark:text-white placeholder-gray-400 font-sans" 
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-10 pb-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <article className="group relative flex flex-col bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 border border-gray-200 dark:border-gray-800 overflow-hidden h-full">
                <Link to="/contrato/sol-8821" className="block relative h-52 w-full overflow-hidden cursor-pointer">
                ...
                <div className="flex flex-col flex-1 p-5 gap-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-lg font-black font-display text-black dark:text-white flex items-center gap-1">
                          1.2 GWh
                          <span className="material-symbols-outlined text-green-600 text-[18px] fill-1">bolt</span>
                      </span>
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800">
                    ...
                    <Link to="/contrato/sol-8821" className="w-full h-11 rounded-xl bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95">
                        Invertir Ahora
                        <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                    </Link>
                  </div>
              ...
              {/* Opportunity Card 2 */}
              <article className="group relative flex flex-col bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 border border-gray-200 dark:border-gray-800 overflow-hidden h-full">
                <Link to="/contrato/wind-2034" className="block relative h-52 w-full overflow-hidden cursor-pointer">
                ...
                <div className="flex flex-col flex-1 p-5 gap-5">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800">
                    ...
                    <Link to="/contrato/wind-2034" className="w-full h-11 rounded-xl bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95">
                        Invertir Ahora
                        <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                    </Link>
                  </div>
              ...
              <article className="group relative flex flex-col bg-white dark:bg-[#1a1a2e] rounded-2xl shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 border border-gray-200 dark:border-gray-800 overflow-hidden h-full hidden lg:flex">
                <Link to="/contrato/hyd-9982" className="block relative h-52 w-full overflow-hidden cursor-pointer">
                ...
                <div className="flex flex-col flex-1 p-5 gap-5">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800">
                    ...
                    <Link to="/contrato/hyd-9982" className="w-full h-11 rounded-xl bg-black dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95">
                        Invertir Ahora
                        <span className="material-symbols-outlined text-[18px]">arrow_forward</span>
                    </Link>
                  </div>
          ...
          <div className="flex flex-col gap-5 pt-8 border-t border-gray-200 dark:border-gray-800">
            <div className="flex items-center justify-between">
              ...
              <Link to="/mercado-secundario" className="text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors underline decoration-primary decoration-2 underline-offset-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 opacity-70 hover:opacity-100 transition-opacity">
                ...
                <article className="flex flex-col bg-white dark:bg-[#1a1a2e] rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-600 transition-colors h-full">
                    <div className="p-5 flex flex-col gap-4 h-full">
                        ...
                        <Link to="/contrato/solar-norte-1" className="w-full py-2 border border-black dark:border-white rounded-lg text-sm font-bold text-center hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors text-black dark:text-white">
                ...
                {/* View More Card */}
                <Link to="/mercado-secundario" className="flex flex-col bg-gray-50 dark:bg-gray-800/50 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 h-full items-center justify-center p-6 text-center hover:bg-white dark:hover:bg-[#1a1a2e] hover:border-primary hover:text-primary dark:hover:border-primary dark:hover:text-primary transition-all cursor-pointer group">
