...
const ForgotPassword: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background-light font-sans text-text-main">
            ...
            <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-card border border-gray-100 flex flex-col overflow-hidden">
                <div className="flex flex-col items-center pt-10 pb-4 px-8">
                    <Link href="/" className="w-48 h-14 relative flex items-center justify-center mb-2 group">
                ...
                <div className="px-10 pb-12 pt-4 flex flex-col gap-6">
                    ...
                    <div className="flex justify-center mt-2">
                        <Link href="/login" className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-text-main text-sm font-bold hover:bg-gray-50 transition-colors group font-display">
