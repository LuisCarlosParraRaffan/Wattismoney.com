...
const SignupSuccess: React.FC = () => {
    return (
        <div className="bg-background-light text-text-main font-display antialiased selection:bg-primary selection:text-black">
            <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
                ...
                <header className="flex items-center justify-between border-b border-gray-100 bg-white px-6 py-4 lg:px-20">
                    ...
                    <a className="hidden text-sm font-medium text-gray-500 hover:text-black sm:block" href="#">
                        ¿Necesitas ayuda?
                    </a>
                </header>
                ...
                <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                    <div className="w-full max-w-lg space-y-8 text-center">
                        ...
                        {/* Action Card */}
                        <div className="mt-8 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl shadow-gray-200/50">
                            <div className="bg-gray-50 p-6">
                                <div className="flex flex-col gap-4">
                                    {/* Primary Button */}
                                    <Link href="/kyc-upload" className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-primary px-6 text-base font-bold text-black shadow-sm transition-transform hover:scale-[1.02] hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                                        <span className="material-symbols-outlined text-[20px]">verified_user</span>
                                        <span>Ir a Verificación de Identidad</span>
                                    </Link>
                                    {/* Secondary Link */}
                                    <div className="text-sm">
                                        <span className="text-gray-500">¿No has recibido el correo? </span>
                                        <a className="font-semibold text-black underline decoration-primary decoration-2 underline-offset-2 hover:decoration-4" href="#">
                                            Reenviar correo
                                        </a>
                                    </div>
                                </div>
                ...
                <footer className="mt-auto border-t border-gray-100 bg-white py-8">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 sm:flex-row lg:px-8">
                        ...
                        <div className="flex gap-6">
                            <a className="text-sm font-medium text-gray-500 hover:text-black" href="#">Privacidad</a>
                            <a className="text-sm font-medium text-gray-500 hover:text-black" href="#">Términos</a>
                            <a className="text-sm font-medium text-gray-500 hover:text-black" href="#">Ayuda</a>
                        </div>
                    </div>
                </footer>
            </div>
