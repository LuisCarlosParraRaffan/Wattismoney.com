        ...
        <div className="bg-background-light text-text-main font-display antialiased min-h-screen flex flex-col">
            ...
            <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                <div className="w-full max-w-lg space-y-8 text-center">
                    <div className="mx-auto flex size-24 items-center justify-center rounded-full bg-yellow-100 p-4">
                        <span className="material-symbols-outlined text-[64px] text-yellow-600">hourglass_empty</span>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-500">
                            Te enviaremos un email cuando tu verificación esté completa.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl">
                        <div className="bg-gray-50 p-6">
                            <div className="flex flex-col gap-4">
                                <Link href="/dashboard" className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-primary px-6 text-base font-bold text-black shadow-sm transition-transform hover:scale-[1.02] hover:bg-primary-hover">
                                    <span className="material-symbols-outlined text-[20px]">dashboard</span>
                                    Ir al Dashboard
                                </Link>
                                <p className="text-sm text-gray-500">
                                    Mientras esperas, puedes explorar la plataforma.
                                </p>
                            </div>
                        </div>
                    </div>
