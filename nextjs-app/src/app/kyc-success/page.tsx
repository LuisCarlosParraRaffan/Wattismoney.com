        ...
        <div className="bg-background-light dark:bg-background-dark text-text-main font-display antialiased min-h-screen flex flex-col">
            ...
            <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
                <div className="w-full max-w-lg space-y-8 text-center">
                    ...
                    <div className="mt-8 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl dark:border-gray-800 dark:bg-neutral-900">
                        <div className="bg-gray-50 p-6 dark:bg-neutral-800">
                            <div className="flex flex-col gap-4">
                                ...
                                <Link href="/dashboard" className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-white border border-gray-200 px-6 text-base font-semibold text-black hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                                    Ir al Dashboard
                                </Link>
                            </div>
                        </div>
