                ...
                <div className="max-w-[1100px] mx-auto p-6 lg:p-12 flex flex-col gap-10 relative z-10 pb-20">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                        ...
                        <div className="flex gap-3 w-full md:w-auto">
                            <button className="flex-1 md:flex-none justify-center items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors shadow-sm text-text-main">
                                <span className="material-symbols-outlined text-[20px]">share</span>
                                Compartir Perfil
                            </button>
                            <button className="flex-1 md:flex-none justify-center items-center gap-2 px-6 py-2 bg-black text-white rounded-lg text-sm font-bold hover:bg-gray-800 transition-colors shadow-lg">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col items-center text-center relative overflow-hidden group">
                                ...
                                <div className="relative mb-4">
                                    <div className="w-32 h-32 rounded-full border-4 border-white shadow-lg bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAnQWCQGcAOKnZ27WNIKK0LNA7_8U9np66Rfm8oqras10Jk2eEpp0e2soup9wuyNryjBgnKxH5fueNV2cdX0E1QIsJxQNpIO3Gkn7tJD76PpllRhWZ1tTyuoS0gAdzLk5pU2ndzG5E7OB50FNeY7-YrRZNgd1ScC9HKuJxKiGdDAisbsWEUwNERYmYPs7iVo1NlJXeVw4rIueUtnJ8g6JMhIasmOMCRg2aY690dVeCUz-vCVUvolIyIEyt3L_YvuYfjClZhvI1OXxk")' }}></div>
                                ...
                                <h2 className="text-2xl font-bold text-text-main">Juan Pérez</h2>
                                <p className="text-slate-500 font-medium mb-4">Inversor Sostenible | Nivel 5</p>
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-xs text-slate-500">Verificado el 12 Oct 2023</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-sm font-bold text-text-main">Seguridad 2FA</span>
                                                <span className="text-xs text-slate-500">Activado</span>
                                            </div>
                                        </div>
                                        <button className="text-xs font-bold underline text-text-main">Configurar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-8 flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                ...
                                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-1 hover:border-primary transition-colors cursor-default">
                                    ...
                                    <span className="text-2xl font-bold text-text-main tracking-tight">3.2 Ton</span>
                                ...
                                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col gap-1 hover:border-primary transition-colors cursor-default">
                                    ...
                                    <span className="text-2xl font-bold text-text-main tracking-tight">12</span>
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <button className="text-sm font-bold text-slate-500 hover:text-black transition-colors">Ver todas</button>
                                </div>
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                    {/* Badge 1 */}
                                    <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-sm border border-gray-100 hover:scale-105 transition-transform">
                                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-yellow-100 to-yellow-300 flex items-center justify-center border-2 border-white shadow-inner">
                                            <span className="material-symbols-outlined text-3xl text-yellow-700">emoji_events</span>
                                        </div>
                                        <span className="text-xs font-bold text-center text-text-main">Pionero Solar</span>
                                    </div>
                                    {/* Badge 2 */}
                                    <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-sm border border-gray-100 hover:scale-105 transition-transform">
                                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-100 to-green-300 flex items-center justify-center border-2 border-white shadow-inner">
                                            <span className="material-symbols-outlined text-3xl text-green-700">forest</span>
                                        </div>
                                        <span className="text-xs font-bold text-center text-text-main">Guardián Eco</span>
                                    </div>
                                    {/* Badge 3 */}
                                    <div className="flex flex-col items-center gap-2 p-3 bg-white rounded-lg shadow-sm border border-gray-100 hover:scale-105 transition-transform">
                                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-blue-300 flex items-center justify-center border-2 border-white shadow-inner">
                                            <span className="material-symbols-outlined text-3xl text-blue-700">water_drop</span>
                                        </div>
                                        <span className="text-xs font-bold text-center text-text-main">Hidro Master</span>
                                    </div>
                                    {/* Badge 4 (Locked) */}
                                    <div className="flex flex-col items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200 border-dashed opacity-60">
                                        <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center">
                                            <span className="material-symbols-outlined text-3xl text-gray-400">lock</span>
                                        </div>
                                        <span className="text-xs font-bold text-center text-slate-500">Inversor Top</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 lg:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-5">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <input className="bg-gray-50 border border-gray-200 text-text-main text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-3 font-semibold" disabled type="text" defaultValue="Juan Pérez García" />
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className="bg-white border border-gray-200 text-text-main text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3 font-medium" type="email" defaultValue="juan.perez@email.com" />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className="bg-white border border-gray-200 text-text-main text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3 font-medium" type="tel" defaultValue="+34 600 000 000" />
                                    </div>
                                </div>
                            </div>
                            {/* Column 2 */}
                            <div className="space-y-5">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className="bg-white border border-gray-200 text-text-main text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3 font-medium" type="text" defaultValue="Calle de la Energía 45, Madrid" />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-sm font-bold text-slate-700">Idioma Preferido</label>
                                    <select className="bg-white border border-gray-200 text-text-main text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-3 font-medium">
                                        <option defaultValue="es">Español</option>
                                        <option value="en">English</option>
                                        <option value="pt">Português</option>
                                    </select>
                                </div>
                                <div className="pt-2">
                                    <a className="text-sm text-primary font-bold hover:underline" href="#">Solicitar cambio de datos sensibles</a>
                                </div>
                            </div>
                        </div>
                    </div>
