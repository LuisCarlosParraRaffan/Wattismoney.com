                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-text-main">Solar Norte I</h3>
                            ...
                            <div className="flex justify-between mb-4">
                                <div>
                                    ...
                                    <p className="text-lg font-black text-text-main">$2,450</p>
                                </div>
                                <div>
                            ...
                            <button className="w-full py-2 border border-black rounded-lg font-bold text-sm hover:bg-black hover:text-white transition-colors">
                                Ver Detalles
                            </button>
                        </div>
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-text-main">Eólica Central II</h3>
                            ...
                            <div className="flex justify-between mb-4">
                                <div>
                                    <span className="text-xs text-slate-500">Precio</span>
                                    <p className="text-lg font-black text-text-main">$3,200</p>
                                </div>
                                <div>
                                    <span className="text-xs text-slate-500">TIR</span>
