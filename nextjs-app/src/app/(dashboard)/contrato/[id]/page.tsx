                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="bg-white p-4 rounded-xl border border-gray-200">
                                    ...
                                    <p className="text-xl font-black text-black">10 MW</p>
                                </div>
                                <div className="bg-white p-4 rounded-xl border border-gray-200">
                                    <p className="text-xs text-gray-500 uppercase font-bold">Plazo</p>
                                    <p className="text-xl font-black text-black">5 años</p>
                                </div>
                                <div className="bg-white p-4 rounded-xl border border-gray-200">
                                ...
                                <div className="bg-white p-4 rounded-xl border border-gray-200">
                                    ...
                                    <p className="text-xl font-black text-black">850 t</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-xl border border-gray-200 sticky top-6">
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <p className="text-2xl font-black text-black">$500 USD</p>
                                    </div>
                                </div>
