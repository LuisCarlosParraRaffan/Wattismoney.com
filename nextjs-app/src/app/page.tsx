    ...
    <div className="bg-white text-gray-900 font-sans">
      ...
      <header className="w-full py-4 px-6 md:px-12 flex items-center justify-between sticky top-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm md:shadow-none">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/signup" className="bg-w-accent text-black px-5 py-2 rounded-full text-sm font-semibold hover:bg-opacity-90 transition-all shadow-sm cursor-pointer hover:opacity-90">
            Registro
          </Link>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Link href="/contratos" className="bg-w-accent text-black px-8 py-3 rounded-full font-semibold hover:bg-yellow-300 transition-colors shadow-sm text-center cursor-pointer hover:opacity-90 flex items-center justify-center">
              Ver Contratos
            </Link>
            <Link href="/como-funciona" className="border border-gray-300 bg-white px-8 py-3 rounded-full font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 group cursor-pointer hover:opacity-90">
